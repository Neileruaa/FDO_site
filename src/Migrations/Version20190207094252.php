 ...
 */
final class Version20190207094252 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE club (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, ville_club VARCHAR(255) NOT NULL, code_postal_club VARCHAR(10) DEFAULT NULL, phone_club VARCHAR(10) DEFAULT NULL, name_club_owner VARCHAR(255) NOT NULL, password VARCHAR(100) DEFAULT NULL, email_club VARCHAR(255) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', UNIQUE INDEX UNIQ_B8EE387227D818F7 (email_club), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE mailbox (id INT AUTO_INCREMENT NOT NULL, message VARCHAR(255) DEFAULT NULL, club INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE resultat (id INT AUTO_INCREMENT NOT NULL, team_id INT DEFAULT NULL, note NUMERIC(10, 2) DEFAULT NULL, nb_gardes NUMERIC(10, 0) DEFAULT NULL, INDEX IDX_E7DB5DE2296CD8AE (team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name_category VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE reglement (id INT AUTO_INCREMENT NOT NULL, pdf_file VARCHAR(255) NOT NULL, title VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE competition_team (competition_id INT NOT NULL, team_id INT NOT NULL, INDEX IDX_CAA3380D7B39D312 (competition_id), INDEX IDX_CAA3380D296CD8AE (team_id), PRIMARY KEY(competition_id, team_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE competition_dance (competition_id INT NOT NULL, dance_id INT NOT NULL, INDEX IDX_EBFCCFB97B39D312 (competition_id), INDEX IDX_EBFCCFB965D64EDD (dance_id), PRIMARY KEY(competition_id, dance_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE competition_judge (competition_id INT NOT NULL, judge_id INT NOT NULL, INDEX IDX_E24CF1C27B39D312 (competition_id), INDEX IDX_E24CF1C2B7D66194 (judge_id), PRIMARY KEY(competition_id, judge_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE judge (id INT AUTO_INCREMENT NOT NULL, name_judge VARCHAR(255) NOT NULL, first_name_judge VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE dance (id INT AUTO_INCREMENT NOT NULL, name_dance VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE row (id INT AUTO_INCREMENT NOT NULL, dance_id INT DEFAULT NULL, category_id INT DEFAULT NULL, num_tour VARCHAR(255) DEFAULT NULL, formation VARCHAR(255) DEFAULT NULL, piste VARCHAR(255) DEFAULT NULL, is_done TINYINT(1) DEFAULT NULL, passage_simul INT DEFAULT NULL, nb_judge INT DEFAULT NULL, INDEX IDX_8430F6DB65D64EDD (dance_id), INDEX IDX_8430F6DB12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE row_team (row_id INT NOT NULL, team_id INT NOT NULL, INDEX IDX_BF6969E883A269F2 (row_id), INDEX IDX_BF6969E8296CD8AE (team_id), PRIMARY KEY(row_id, team_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE team_dance (team_id INT NOT NULL, dance_id INT NOT NULL, INDEX IDX_DF4DB42F296CD8AE (team_id), INDEX IDX_DF4DB42F65D64EDD (dance_id), PRIMARY KEY(team_id, dance_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE team_dancer (team_id INT NOT NULL, dancer_id INT NOT NULL, INDEX IDX_C7078F70296CD8AE (team_id), INDEX IDX_C7078F70A7CAA267 (dancer_id), PRIMARY KEY(team_id, dancer_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
