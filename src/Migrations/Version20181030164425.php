 ...
 */
final class Version20181030164425 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id_user INT AUTO_INCREMENT NOT NULL, username VARCHAR(30) DEFAULT NULL, email VARCHAR(40) DEFAULT NULL, password VARCHAR(100) DEFAULT NULL, roles JSON NOT NULL, PRIMARY KEY(id_user)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
