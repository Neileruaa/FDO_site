 ...
 */
final class Version20181015082441 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE dancer_team (danseur_id INT NOT NULL, equipe_id INT NOT NULL, INDEX IDX_BFE928E75942A4C7 (danseur_id), INDEX IDX_BFE928E76D861B89 (equipe_id), PRIMARY KEY(danseur_id, equipe_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE danseur_equipe (danseur_id INT NOT NULL, equipe_id INT NOT NULL, INDEX IDX_1295AC615942A4C7 (danseur_id), INDEX IDX_1295AC616D861B89 (equipe_id), PRIMARY KEY(danseur_id, equipe_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
